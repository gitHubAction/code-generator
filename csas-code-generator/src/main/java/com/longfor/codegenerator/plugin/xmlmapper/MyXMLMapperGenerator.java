package com.longfor.codegenerator.plugin.xmlmapper;

import com.longfor.codegenerator.plugin.xmlmapper.element.MyInsertSelectiveElementGenerator;
import com.longfor.codegenerator.plugin.xmlmapper.element.MyUpdateByExampleSelectiveElementGenerator;
import com.longfor.codegenerator.plugin.xmlmapper.element.MyUpdateByPrimaryKeySelectiveElementGenerator;
...
public class MyXMLMapperGenerator extends XMLMapperGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        // 针对selective动态的if标签判断  VARCHAR 增加 != '' 判断
