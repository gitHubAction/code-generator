 ...
 */
package com.longfor.codegenerator.plugin.xmlmapper.element;
 ...
 * 
 */
public class MyUpdateByExampleSelectiveElementGenerator extends
        AbstractXmlElementGenerator {

    public MyUpdateByExampleSelectiveElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        for (IntrospectedColumn introspectedColumn : ListUtilities.removeGeneratedAlwaysColumns(introspectedTable
            ...
            if(introspectedColumn.getJdbcTypeName() == "VARCHAR"){
                sb.append(" and ");
